...
import { LogIn, UserPlus, Moon, Sun, LogOut, Package, Shield, User } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center space-x-2">
            ...
            />
            <span className="text-xl font-bold text-dark dark:text-light">ProxyFlow</span>
          </Link>

          <nav className="hidden md:flex space-x-8">
            <Link to="/" className="text-gray-700 dark:text-gray-300 hover:text-primary font-medium">Buy Proxy</Link>
            <Link to="/pricing" className="text-gray-700 dark:text-gray-300 hover:text-primary font-medium">Pricing</Link>
            <Link to="/faq" className="text-gray-700 dark:text-gray-300 hover:text-primary font-medium">FAQ</Link>
            {/* {user?.role === 'admin' && (
          ...
          <div className="flex items-center space-x-3">
            ...
            {user ? (
              ...
              <>
                <Link to="/login" className="flex items-center space-x-1 text-gray-700 dark:text-gray-300 hover:text-primary">
                  <LogIn className="w-5 h-5" />
                  <span className="hidden sm:inline">Login</span>
                </Link>
                <Link to="/signup" className="flex items-center space-x-1 bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-700">
